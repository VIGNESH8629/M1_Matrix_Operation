...
int main()
{
   ...
   while(matrix_operation!=4){
    printf("\n*********Welcome to Matrix operation********** \t");
    printf("\n >>1) Addition of  Two Matirx");
    printf("\n >>2) Multiplication of Two Matrix");
    printf("\n >>3) Square of matrix");
    printf("\n >>4) Quit ");
    printf("\n Enter your  choice ");
    scanf("%d", &matrix_operation);
     if(matrix_operation==1){
        matrix_add();
    }
    else if(matrix_operation == 2){
        matrix_multiply();
    }
    else if(matrix_operation == 3){
        matrix_square();
    }
    else if (matrix_operation == 4){
        printf("Thank you");
    }
    else{
        printf("close");
